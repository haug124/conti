 ...
 * Base block: cards
 * Sources (car-landing only):
 *   - main .image-list.image-list--a  → vehicle-type grid (image + title + Read more)
 *   - main .image-list.image-list--d  → "Why Continental" grid (image + title + description + Read more)
 ...
 *   cards-feature renders the same table as cards-story but overlays the title/
 *   description on the full-bleed image via CSS (see cards-feature.css); the
 *   whole tile links. Structure is identical — only the visual treatment differs.
 *
 ...
 *         > (span.cmp-image-list__item-date)        (optional; image-list--a)
 *         > .cmp-image-list__item-title-link > .cmp-image-list__item-title
 *         > (span.cmp-image-list__item-description) (optional; image-list--d)
